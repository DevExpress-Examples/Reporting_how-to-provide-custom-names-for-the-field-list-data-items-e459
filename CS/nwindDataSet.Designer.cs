...
namespace docCustomDataItemsNames {
    ...
    public partial class nwindDataSet : global::System.Data.DataSet, IDataDictionary {
        ...
        string IDataDictionary.GetObjectDisplayName(string dataMember) {
            ...
            if(dataMember.EndsWith("ID")) {
                return null;
            }

            // Hide the 'Products' table, as its fields are accessible via the 'CategoriesProducts' table only.
            if(dataMember.StartsWith("Products")) {
                return null;
            }
        ...
        public string ChangeNames(string name) {
            ...
            foreach(char symb in name) {
                ...
                // To avoid spaces inside abbreviations, check if the previous character is of upper case, too.
